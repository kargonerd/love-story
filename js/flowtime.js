...
var Flowtime = (function ()
{
	...
	var _crossDirection = Brav1Toolbox.hasClass(ftContainer, CROSS_DIRECTION_CLASS);       // stopFlag to set the cross direction layout and logic
	...
	var _scrollTheSection = Brav1Toolbox.hasClass(ftContainer, SCROLL_THE_SECTION_CLASS);  // stopFlag to set the scroll the section logic
	var _sectionsStatus = [];
  ...
  */
	...
	function overviewZoomTypeA(out) {
		...
		if (out) {
			...
			//
			ftContainer.style[_transformProperty] = "translate3d(" + offsetX + "%, " + offsetY + "%, 0) scale(" + scale/100 + ", " + scale/100 + ")";
			ftContainer.style[Brav1Toolbox.getPrefixed("transition-duration")] = "3000ms"
			ftContainer.style[Brav1Toolbox.getPrefixed("transition-timing-function")] = "cubic-bezier(0, 0.5, 0, 1)"
		}
	}
